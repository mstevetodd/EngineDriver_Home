...
* :ref:`Big Buttons - Left <configuration/setup_wizard:throttle screen layout>`
* :ref:`Big Buttons - Right <configuration/setup_wizard:throttle screen layout>`
...
Enter \'Forward\' or blank for normal/default behaviour.
...
Enter \'Reverse\' or blank for normal/default behaviour.
...
Enter 'Fwd' or blank for normal/default behaviour.
...
Enter 'Rev' or blank for normal/default behaviour.
...
If this preference is enabled |ed| will show loco DCC Address(es) instead of the |ROSTER| Name(s) on the |T-S|.  It will ignore the |ROSTER| name for the :guilabel:`Select` button label.  
...
The following preferences provide options for when and how the :ref:`Default Function Labels <operation/interface:function defaults screen>` are displayed.
...
If this preference is enabled |ed| will *always* display the :ref:`Default Function Labels <operation/interface:function defaults screen>` (configured inside |ed|\ ) instead of labels from |ROSTER| entries. It will ignore the |ROSTER| for the Function button labels.  
...
* :ref:`Simple <configuration/setup_wizard:throttle screen layout>`
...
|ed| can play synchronised loco sounds through the speaker of your Android device/phone, or through BlueTooth speakers connected to your device/phone.
