...
The current Production version (**v2.43.227**) is available in the `Google Play Store <https://play.google.com/store/apps/details?id=jmri.enginedriver>`_ or by direct download of the .apk file below.
...
.. note:: 
   ...
   If you have an **Amazon Fire Tablet**, the version of |ED| on the **Amazon Appstore** has not been updated for some time as the store has become too difficult to work with. If you have an Amazon device, you can still install the latest version by manuallly instaling the .apk file below. See instructions below.  
...
* `EngineDriver-2.44.231.apk <../_static/apk/EngineDriver-2.44.231.apk>`_
...
* `EngineDriver-2.29.127.apk <../_static/apk/EngineDriver-2.29.127.apk>`_ | Last version to support Android 4.0.4
...
* `EngineDriver-2.20.59.apk <../_static/apk/EngineDriver-2.20.59.apk>`_ | Last version to support Android versions 2.1 - 4.0.3
